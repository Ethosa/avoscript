<template>
  <div class="flex flex-col w-full h-full" v-if="avoscriptVersion != ''">
    <div
      ref="titledev"
      class="w-full h-min flex justify-center text-5xl pb-16"
      
    >
      AVOScript
      <span class="flex text-2xl items-end pl-4">{{avoscriptVersion}}</span>
    </div>
    <div
